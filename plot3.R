# This script plots graph #3 for Week 1 assignment. It assumes the data4 data frame is loaded with correct content, filtered for the two days we need.
...
# Plot all the elements for the graph to the open device
